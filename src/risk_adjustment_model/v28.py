...
class V28Model(BaseMedicareModel):
    """
    Class to run CMS V24 Model
    """

    def __init__(self, version='v28', year=None):
    ...
    def _get_coding_intensity_adjuster(self) -> float:
        ...
        """
        if self.model_year in [2024, 2025]:
    ...
    def _age_sex_edits(self, gender, age, dx_code, category):
        ...
        new_category = self._age_sex_edit_4(age, dx_code)
    ...
    def determine_disease_interactions(self, categories: list) -> list:
        cancer = False

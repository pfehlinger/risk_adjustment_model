...
def determine_disease_interactions(categories: list, disabled: bool) -> list:
    ...
    g_substance_use_disorder_v28 = any(category in categories for category in g_substance_use_disorder_v28_list)
    ...
    interactions = {
        ...
        'gSubUseDisorder_gPsych_V28': all([g_substance_use_disorder_v28, g_pyshiatric_v28]),
